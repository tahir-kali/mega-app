  ...
  override func makeContent() -> CalendarViewContent {
    ...
    return CalendarViewContent(
      ...
      .dayItemProvider { [calendar, dayDateFormatter] day in
        ...
        if isSelectedStyle {
          invariantViewProperties.backgroundShapeDrawingConfig.fillColor = .systemIndigo
            invariantViewProperties.textColor = .white
            invariantViewProperties.backgroundShapeDrawingConfig.borderColor = .systemIndigo
        }
